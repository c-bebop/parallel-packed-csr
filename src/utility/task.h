...
struct task {
  ...
  // TODO: Why is src and target of type int? Are there edges with negative row/column
  // entries?!
  uint32_t src;     // Source vertex for this task's edge
  uint32_t target;  // Target vertex for this task's edge
};
